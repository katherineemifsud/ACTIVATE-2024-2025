...
ax1.scatter(bin_center,  final_clear_conc[11], label='Leg 12', color='teal')
ax2.scatter(bin_center, final_cloud_conc[11], label='Leg 12', color='teal')
ax1.scatter(bin_center,  final_clear_conc[12], label='Leg 13', color='slateblue')
ax2.scatter(bin_center, final_cloud_conc[12], label='Leg 13', color='slateblue')
ax1.scatter(bin_center,  final_clear_conc[13], label='Leg 14', color='gold')
ax2.scatter(bin_center, final_cloud_conc[13], label='Leg 14', color='gold')
ax1.scatter(bin_center,  final_clear_conc[14], label='Leg 15', color='olivedrab')
ax2.scatter(bin_center, final_cloud_conc[14], label='Leg 15', color='olivedrab')

ax1.set_xlim([10**0.2, 10**1.8])
ax1.set_ylim([10**-5, 10**1.3])
ax2.set_xlim([10**0.1, 10**1.9])
ax2.set_ylim([10**-4.3, 10**2.8])
