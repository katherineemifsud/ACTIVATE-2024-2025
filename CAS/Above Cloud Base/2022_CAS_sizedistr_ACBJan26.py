...
ax1.scatter(bin_center,  final_clear_conc[15], label='Leg 16', color='dimgrey')
ax2.scatter(bin_center, final_cloud_conc[15], label='Leg 16', color='dimgrey')

ax1.set_xlim([10**0.2, 10**1.8])
ax1.set_ylim([10**-6, 10**2])
ax2.set_xlim([10**0.1, 10**1.8])
...
ax1.legend(prop={'size': 4.5})
ax2.legend(prop={'size': 4.5})
plt.tight_layout()
plt.show()
#%%
