...
ax1.scatter(bin_center,  final_clear_conc[20], label='Leg 21', color='royalblue')
ax2.scatter(bin_center, final_cloud_conc[20], label='Leg 21', color='royalblue')
