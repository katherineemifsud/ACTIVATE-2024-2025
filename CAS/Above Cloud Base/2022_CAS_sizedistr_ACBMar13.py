...
ax1.scatter(bin_center,  final_clear_conc[11], label='Leg 12', color='blueviolet')
ax2.scatter(bin_center, final_cloud_conc[11], label='Leg 12', color='blueviolet')
ax1.scatter(bin_center,  final_clear_conc[12], label='Leg 13', color='grey')
ax2.scatter(bin_center, final_cloud_conc[12], label='Leg 13', color='grey')
...
ax1.scatter(bin_center,  final_clear_conc[14], label='Leg 16', color='grey')
