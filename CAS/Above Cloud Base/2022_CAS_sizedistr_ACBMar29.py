...
ax1.scatter(bin_center,  final_clear_conc[6], label='Leg 7', color='slateblue')
ax2.scatter(bin_center, final_cloud_conc[6], label='Leg 7', color='slateblue')
...
ax1.scatter(bin_center,  final_clear_conc[8], label='Leg 9', color='teal')
ax2.scatter(bin_center, final_cloud_conc[8], label='Leg 9', color='teal')
ax1.scatter(bin_center,  final_clear_conc[9], label='Leg 10', color='slateblue')
ax2.scatter(bin_center, final_cloud_conc[9], label='Leg 10', color='slateblue')
...
ax1.scatter(bin_center,  final_clear_conc[13], label='Leg 14', color='grey')
ax2.scatter(bin_center, final_cloud_conc[13], label='Leg 14', color='grey')
ax1.scatter(bin_center,  final_clear_conc[14], label='Leg 15', color='cyan')
ax2.scatter(bin_center, final_cloud_conc[14], label='Leg 15', color='cyan')
ax1.scatter(bin_center,  final_clear_conc[15], label='Leg 16', color='blueviolet')
ax2.scatter(bin_center, final_cloud_conc[15], label='Leg 16', color='blueviolet')
ax1.scatter(bin_center,  final_clear_conc[16], label='Leg 17', color='olive')
ax2.scatter(bin_center, final_cloud_conc[16], label='Leg 17', color='olive')
ax1.scatter(bin_center,  final_clear_conc[17], label='Leg 18', color='deeppink')
ax2.scatter(bin_center, final_cloud_conc[17], label='Leg 18', color='deeppink')



ax1.set_xlim([10**0.2, 10**2])
ax1.set_ylim([10**-5.5, 10**2])
ax2.set_xlim([10**0.1, 10**2])
ax2.set_ylim([10**-5, 10**3.5])
