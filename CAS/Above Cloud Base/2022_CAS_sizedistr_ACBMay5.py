...
for date in dates_CAS:
    ...
    ACB_Start = leg_dictionary['LegIndex_03']['StartTimes']
    ACB_Stop = leg_dictionary['LegIndex_03']['StopTimes']
...
ax1.scatter(bin_center,  final_clear_conc[7], label='Leg 8', color='navy')
ax2.scatter(bin_center, final_cloud_conc[7], label='Leg 8', color='navy')
ax1.scatter(bin_center,  final_clear_conc[8], label='Leg 9', color='orange')
ax2.scatter(bin_center, final_cloud_conc[8], label='Leg 9', color='orange')
ax1.scatter(bin_center,  final_clear_conc[9], label='Leg 10', color='cyan')
ax2.scatter(bin_center, final_cloud_conc[9], label='Leg 10', color='cyan')
ax1.scatter(bin_center,  final_clear_conc[10], label='Leg 11', color='lawngreen')
ax2.scatter(bin_center, final_cloud_conc[10], label='Leg 11', color='lawngreen')
ax1.scatter(bin_center,  final_clear_conc[11], label='Leg 12', color='slateblue')
ax2.scatter(bin_center, final_cloud_conc[11], label='Leg 12', color='slateblue')
ax1.scatter(bin_center,  final_clear_conc[12], label='Leg 13', color='gold')
ax2.scatter(bin_center, final_cloud_conc[12], label='Leg 13', color='gold')
ax1.scatter(bin_center,  final_clear_conc[13], label='Leg 14', color='blueviolet')
ax2.scatter(bin_center, final_cloud_conc[13], label='Leg 14', color='blueviolet')
ax1.scatter(bin_center,  final_clear_conc[14], label='Leg 15', color='slateblue')
ax2.scatter(bin_center, final_cloud_conc[14], label='Leg 15', color='slateblue')
ax1.scatter(bin_center,  final_clear_conc[15], label='Leg 16', color='grey')
ax2.scatter(bin_center, final_cloud_conc[15], label='Leg 16', color='grey')
ax1.scatter(bin_center,  final_clear_conc[16], label='Leg 17', color='deeppink')
ax2.scatter(bin_center, final_cloud_conc[16], label='Leg 17', color='deeppink')
ax1.scatter(bin_center,  final_clear_conc[17], label='Leg 18', color='lavender')
ax2.scatter(bin_center, final_cloud_conc[17], label='Leg 18', color='lavender')
ax1.scatter(bin_center,  final_clear_conc[18], label='Leg 19', color='olive')
ax2.scatter(bin_center, final_cloud_conc[18], label='Leg 19', color='olive')
ax1.scatter(bin_center,  final_clear_conc[19], label='Leg 20', color='mediumblue')
ax2.scatter(bin_center, final_cloud_conc[19], label='Leg 20', color='mediumblue')
ax1.scatter(bin_center,  final_clear_conc[20], label='Leg 21', color='springgreen')
ax2.scatter(bin_center, final_cloud_conc[20], label='Leg 21', color='springgreen')
ax1.scatter(bin_center,  final_clear_conc[21], label='Leg 22', color='indianred')
ax2.scatter(bin_center, final_cloud_conc[21], label='Leg 22', color='indianred')


ax1.set_xlim([10**0.2, 10**2])
ax1.set_ylim([10**-6, 10**3])
