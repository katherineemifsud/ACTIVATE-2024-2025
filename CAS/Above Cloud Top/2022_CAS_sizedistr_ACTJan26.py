...
ax1.scatter(bin_center,  final_clear_conc[7], label='Leg 8', color='teal')
ax2.scatter(bin_center, final_cloud_conc[7], label='Leg 8', color='teal')


ax1.set_xlim([10**0.3, 10**1.6])
ax1.set_ylim([10**-5, 10**0.5])
ax2.set_xlim([10**0.2, 10**1.9])
ax2.set_ylim([10**-2, 10**2.6])
