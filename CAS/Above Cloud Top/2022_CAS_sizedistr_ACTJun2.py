...
ax1.scatter(bin_center,  final_clear_conc[5], label='Leg 6', color='darkgreen')
ax2.scatter(bin_center, final_cloud_conc[5], label='Leg 6', color='darkgreen')
...
ax1.set_xlim([10**0.2, 10**1.6])
ax1.set_ylim([10**-6, 10**1])
ax2.set_xlim([10**0.2, 10**1.9])
ax2.set_ylim([10**-4.4, 10**2.6])
