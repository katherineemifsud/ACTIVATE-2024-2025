...
for date in dates_CAS:
    ...
    fname_CAS = sorted(glob.glob(
        f'/home/disk/eos4/kathem24/activate/data/2020/CAS/ACTIVATE-LARGE-CAS_HU25_{datestr}_R*.ict'
    ), reverse=True)
...
# save_dir = "/home/disk/eos4/kathem24/activate/data/2020/CAS"
...
# output_path = "Dry_mass_BCB2020_lessthan100massREAL.csv"
...
# with open("CAS_slope_massLE1002020.pkl", "wb") as f:
#     pickle.dump(filtered_slope_mass100gone, f)
# print("Saved CAS slope-filtered dataset.")
# print("Saved to:", os.path.abspath("CAS_slope_massLE1002020.pkl"))
# print("Exists?", os.path.exists("CAS_slope_massLE1002020.pkl"))
#%%
...
with open("CAS_concentration_massLE1002020.pkl", "wb") as f:
...
# np.savez("CAS_average_drysize_nomass1002020.npz",
#          bins=common_bins,
#          average=average_dN_dD_dry)
# print("Saved CAS averaged distribution.")
# print("Saved to:", os.path.abspath("CAS_ddry_massLE1002020.pkl"))
# print("Exists?", os.path.exists("CAS_ddry_massLE1002020.pkl"))
#%%
...
save_dir = "/home/disk/eos4/kathem24/activate/data/2020/CAS"
os.makedirs(save_dir, exist_ok=True)
save_path = os.path.join(save_dir, "CAS_FMAS2020_wind_bin_concentration_plot_data.pkl")
plot_data = {
...
plt.title("CAS Below Cloud Base FMAS 2020", fontsize=16, fontweight='bold')
legend_labels_mass = [
    plt.Line2D([0], [0], marker='o', color='w', markerfacecolor=colors[idx], markersize=10, 
...
plt.title("CAS Below Cloud Base FMAS 2020", fontsize=20, fontweight='bold')
plt.legend(fontsize=13, title_fontsize=14, loc='best', frameon=True)
plt.tight_layout()
plt.xticks(fontsize=20, fontweight='bold')
plt.yticks(fontsize=20, fontweight='bold')
...
save_dir = "/home/disk/eos4/kathem24/activate/data/2020/CAS"
os.makedirs(save_dir, exist_ok=True)
save_path = os.path.join(save_dir, "CAS_FMAS2020_wind_bin_mass_plot_data.pkl")
mass_plot_data = {
    "windspeed_bins": windspeed_bins,
