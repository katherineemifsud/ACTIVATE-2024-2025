...
plt.show()
# %%
#all cases no turbulence gccn concentration vs accumulated rain but just the trend lines, no scatter points 
cases = {
    "Base": {
        "r": r_dry,
        "n0": n0_r,
...
accum_rain_base   = accum_rain_base.copy()
accum_rain_lowna  = accum_rain_lowna.copy()
accum_rain_highna = accum_rain_highna.copy()
