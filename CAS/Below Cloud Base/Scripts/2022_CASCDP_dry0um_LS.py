...
bin_center=[0.555, 0.645, 0.715, 0.785, 0.855, 0.925, 0.995, 1.07, 1.14, 1.21, 1.38, 1.75, 
...
for flight_data in master_CAS_BCB:
    for bin_means in flight_data:
        ...
        for bin_label in range(0, 30):
            ...
            Y_calc[bin_key_Y] = np.nanmean(bin_means[bin_key_Y]) * bin_log[bin_label]
            N_calc[bin_key_N] = np.nanmean(bin_means[bin_key_N]) * bin_log[bin_label]
