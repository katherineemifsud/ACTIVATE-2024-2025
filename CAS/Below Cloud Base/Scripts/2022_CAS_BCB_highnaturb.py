...
mask = r_dry_highnaturb > 0.5e-6  # radius > 0.5 µm → diameter > 1 µm
gccn_m3 = np.sum(n0_r_highnaturb[:, mask], axis=1)
accum_rain_highnaturb = np.max(LWP_highnaturb, axis=1) - LWP_highnaturb[:, -1]  # units: kg m^-2 = mm
