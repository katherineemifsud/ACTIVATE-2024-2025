...
precip_bin_name = ['dNdlogD_liquid_005_2DS', 'dNdlogD_liquid_006_2DS','dNdlogD_liquid_007_2DS', 'dNdlogD_liquid_008_2DS',
                   'dNdlogD_liquid_009_2DS', 'dNdlogD_liquid_010_2DS',
                   'dNdlogD_liquid_011_2DS', 'dNdlogD_liquid_012_2DS',
                   'dNdlogD_liquid_013_2DS', 'dNdlogD_liquid_014_2DS',
                   'dNdlogD_liquid_015_2DS', 'dNdlogD_liquid_016_2DS',
                   'dNdlogD_liquid_017_2DS', 'dNdlogD_liquid_018_2DS',
                   'dNdlogD_liquid_019_2DS', 'dNdlogD_liquid_020_2DS', 
                   'dNdlogD_liquid_021_2DS', 'dNdlogD_liquid_022_2DS',
                   'dNdlogD_liquid_023_2DS','dNdlogD_liquid_024_2DS',
                    'dNdlogD_liquid_025_2DS','dNdlogD_liquid_026_2DS',
                    'dNdlogD_liquid_027_2DS', 'dNdlogD_liquid_028_2DS',
                    'dNdlogD_liquid_029_2DS', 'dNdlogD_liquid_030_2DS',
                    'dNdlogD_liquid_031_2DS', 'dNdlogD_liquid_032_2DS', 
                    'dNdlogD_liquid_033_2DS', 'dNdlogD_liquid_034_2DS', 
                    'dNdlogD_liquid_035_2DS', 'dNdlogD_liquid_036_2DS', 
                    'dNdlogD_liquid_037_2DS', 'dNdlogD_liquid_038_2DS',
                    'dNdlogD_liquid_039_2DS', 'dNdlogD_liquid_040_2DS',
                    'dNdlogD_liquid_041_2DS', 'dNdlogD_liquid_042_2DS', 
                    'dNdlogD_liquid_043_2DS', 'dNdlogD_liquid_044_2DS', 
                    'dNdlogD_liquid_045_2DS', 'dNdlogD_liquid_046_2DS',
                    'dNdlogD_liquid_047_2DS', 'dNdlogD_liquid_048_2DS', 
                    'dNdlogD_liquid_049_2DS', 'dNdlogD_liquid_050_2DS',
                    'dNdlogD_liquid_051_2DS', 'dNdlogD_liquid_052_2DS', 
                    'dNdlogD_liquid_053_2DS', 'dNdlogD_liquid_054_2DS',
                    'dNdlogD_liquid_055_2DS', 'dNdlogD_liquid_056_2DS',
                    'dNdlogD_liquid_057_2DS', 'dNdlogD_liquid_058_2DS',
                    'dNdlogD_liquid_059_2DS', 'dNdlogD_liquid_060_2DS',
                    'dNdlogD_liquid_061_2DS', 'dNdlogD_liquid_062_2DS',
                    'dNdlogD_liquid_063_2DS', 'dNdlogD_liquid_064_2DS', 
                    'dNdlogD_liquid_065_2DS', 'dNdlogD_liquid_066_2DS',
                    'dNdlogD_liquid_067_2DS', 'dNdlogD_liquid_068_2DS', 
                    'dNdlogD_liquid_069_2DS', 'dNdlogD_liquid_070_2DS',
                    'dNdlogD_liquid_071_2DS', 'dNdlogD_liquid_072_2DS',
                    'dNdlogD_liquid_073_2DS', 'dNdlogD_liquid_074_2DS', 
                    'dNdlogD_liquid_075_2DS', 'dNdlogD_liquid_076_2DS', 
                    'dNdlogD_liquid_077_2DS', 'dNdlogD_liquid_078_2DS',
                    'dNdlogD_liquid_079_2DS', 'dNdlogD_liquid_080_2DS',
                    'dNdlogD_liquid_081_2DS', 'dNdlogD_liquid_082_2DS',
                    'dNdlogD_liquid_083_2DS', 'dNdlogD_liquid_084_2DS',
                    'dNdlogD_liquid_085_2DS', 'dNdlogD_liquid_086_2DS',
                    'dNdlogD_liquid_087_2DS', 'dNdlogD_liquid_088_2DS',
                    'dNdlogD_liquid_089_2DS', 'dNdlogD_liquid_090_2DS', 
                    'dNdlogD_liquid_091_2DS', 'dNdlogD_liquid_092_2DS',
                    'dNdlogD_liquid_093_2DS', 'dNdlogD_liquid_094_2DS', 
                    'dNdlogD_liquid_095_2DS', 'dNdlogD_liquid_096_2DS',
                    'dNdlogD_liquid_097_2DS', 'dNdlogD_liquid_098_2DS', 
                    'dNdlogD_liquid_099_2DS', 'dNdlogD_liquid_100_2DS', 
                    'dNdlogD_liquid_101_2DS', 'dNdlogD_liquid_102_2DS',
                    'dNdlogD_liquid_103_2DS', 'dNdlogD_liquid_104_2DS', 
                    'dNdlogD_liquid_105_2DS', 'dNdlogD_liquid_106_2DS',
                    'dNdlogD_liquid_107_2DS', 'dNdlogD_liquid_108_2DS', 
                    'dNdlogD_liquid_109_2DS', 'dNdlogD_liquid_110_2DS', 
                    'dNdlogD_liquid_111_2DS', 'dNdlogD_liquid_112_2DS', 
                    'dNdlogD_liquid_113_2DS', 'dNdlogD_liquid_114_2DS', 
                    'dNdlogD_liquid_115_2DS', 'dNdlogD_liquid_116_2DS', 
                    'dNdlogD_liquid_117_2DS', 'dNdlogD_liquid_118_2DS', 
                    'dNdlogD_liquid_119_2DS', 'dNdlogD_liquid_120_2DS', 
                    'dNdlogD_liquid_121_2DS', 'dNdlogD_liquid_122_2DS', 
                    'dNdlogD_liquid_123_2DS', 'dNdlogD_liquid_124_2DS', 
                    'dNdlogD_liquid_125_2DS', 'dNdlogD_liquid_126_2DS', 
                    'dNdlogD_liquid_127_2DS','dNdlogD_liquid_128_2DS']
twoDS = []
dates_twoDS = [
    '2022-01-11', '2022-01-12', '2022-01-15', '2022-01-18', 
    '2022-01-19', '2022-01-24', '2022-01-26', '2022-01-27',
...
##RUN BEFORE RUNNING PHASE SPACE CODE 
...
Bin_Lower = [51.30, 62.70, 74.10, 85.50, 96.90, 
             ...
             347.70, 359.10, 370.50, 381.90, 393.30, 404.70, 416.10, 
             427.50, 438.90, 450.30, 461.70, 473.10, 484.50, 495.90, 
             507.30, 518.70, 530.10, 541.50, 552.90, 564.30, 575.70, 
             587.10, 598.50, 609.90, 621.30, 632.70, 644.10, 655.50, 
             666.90, 678.30, 689.70, 701.10, 712.50, 723.90, 735.30, 
             746.70, 758.10, 769.50, 780.90, 792.30, 803.70, 815.10, 
             826.50, 837.90, 849.30, 860.70, 872.10, 883.50, 894.90, 
             906.30, 917.70, 929.10, 940.50, 951.90, 963.30, 974.70, 
             986.10, 997.50, 1008.90, 1020.30, 1031.70, 1043.10, 1054.50, 
             1065.90, 1077.30, 1088.70, 1100.10, 1111.50, 1122.90, 1134.30, 
             1145.70, 1157.10, 1168.50, 1179.90, 1191.30, 1202.70, 1214.10, 
...
# %%
# Step 1: Identify rows with ANY missing precipitation data
missing_precip_legs = combined_mass_precip[
    combined_mass_precip[precip_bin_name].isnull().any(axis=1)
]

print(f"Number of legs with missing precipitation data: {len(missing_precip_legs)}")
cleaned_combined_mass_precip = combined_mass_precip.dropna(subset=precip_bin_name)
print(f"Remaining legs after removing invalid ones: {len(cleaned_combined_mass_precip)}")

# %%
# Prepare features (X) and target (y)
precip_bin_name = [col for col in df_precip.columns if 'dNdlogD' in col]  # Precip bins

# Features (predictors)
X = combined_mass_precip[['Mass', 'dryintercept', 'D', 'Windspeed']]

# Target: Total Precipitation (sum of bins)
combined_mass_precip['Total_Precip'] = combined_mass_precip[precip_bin_name].sum(axis=1)
y = combined_mass_precip['Total_Precip']
...
plt.title('Feature Importance in Precipitation Prediction', fontsize=16, fontweight='bold')
plt.grid()
plt.show()
...
plt.hist(df_combined['Mass'], bins=50, color='orange', alpha=0.7)
plt.xlabel('Mass')
plt.ylabel('Frequency')
plt.title('Distribution of Mass Values (New Calculation)')
plt.grid()
plt.show()


# %%
df_precip = df_precip[df_precip['Date'] != '2022-06-18']


# %%
duplicates = df_combined.duplicated(subset=['Date', 'Leg_index'], keep=False)
print(f"Number of duplicate entries in df_combined: {duplicates.sum()}")
print(df_combined[duplicates].head(20))
...
# Group by Date and Leg_index to calculate mass at the leg level
df_combined_fixed = (
    df_combined.groupby(['Date', 'Leg_index'], as_index=False)
    .agg({
        'D': 'first',                # Take the first value (already leg-level)
        'dryintercept': 'first',     # Take the first value (already leg-level)
        'Windspeed': 'first'         # Take the first value (already leg-level)
    })
)

# Compute Mass directly for each leg
df_combined_fixed['Mass'] = df_combined_fixed.apply(
    lambda row: calculate_mass(row['dryintercept'], row['D']), axis=1
)

# Print results
print(df_combined_fixed.groupby('Date')['Leg_index'].nunique())


# %%
print(df_combined.groupby('Date')['Leg_index'].nunique())
print(df_precip.groupby('Date')['Leg_index'].nunique())

# %%
# Rebuild df_combined with correct leg-level structure
combined_data = {
    'Date': [],
    'Leg_index': [],
    'D': [],
...
for i, flight in enumerate(master_BCB):
    for j, leg_data in enumerate(flight):  # Each entry corresponds to a leg
        try:
            ...
            # Append data for this leg
            combined_data['Date'].append(date)
            combined_data['Leg_index'].append(j)  # Leg index for alignment
            combined_data['D'].append(D)
            combined_data['dryintercept'].append(dryintercept)
            combined_data['Windspeed'].append(corrected_windspeed)
...
# Confirm Mass calculation worked
print(df_combined[['Date', 'Leg_index', 'Mass']].head(20))
print(f"Number of legs in df_combined: {len(df_combined)}")

#%%
# Count missing values for 'D' and 'dryintercept'
missing_D = df_combined['D'].isna().sum()
missing_dryintercept = df_combined['dryintercept'].isna().sum()
print(f"Missing 'D': {missing_D}, Missing 'dryintercept': {missing_dryintercept}")

# Check rows where mass calculation failed (NaNs in 'Mass')
missing_mass = df_combined[df_combined['Mass'].isna()]
print(f"Number of legs with missing Mass: {len(missing_mass)}")

# Print problematic rows for inspection
print(missing_mass[['Date', 'Leg_index', 'D', 'dryintercept']])

# %%
# Merge the datasets
final_combined = pd.merge(df_combined, df_precip, 
                          on=['Date', 'Leg_index'], 
                          how='inner')

# Print merged results
print(final_combined[['Date', 'Leg_index', 'Mass']].head(20))
print(f"Length of final_combined: {len(final_combined)}")

# %%
for date in comparison[comparison['diff'] > 0].index:
    missing_legs = sorted(list(set(df_precip[df_precip['Date'] == date]['Leg_index']) -
                               set(df_combined[df_combined['Date'] == date]['Leg_index'])))
    print(f"Date {date}: Missing Legs -> {missing_legs}")
    
    # Inspect whether data exists for these legs
    for leg in missing_legs:
        check = df_combined[(df_combined['Date'] == date) & (df_combined['Leg_index'] == leg)]
        if check.empty:
            print(f"  Leg {leg} has NO entry in df_combined!")
        else:
            print(f"  Leg {leg} exists but was DROPPED!")
...
for i, flight in enumerate(master_BCB):
    for j, wind_alt in enumerate(flight):  # Each entry corresponds to a leg
        try:
            # Extract leg-level data
            date = wind_alt['Date']
            wind_mean = wind_alt['Winds_mean'][0]
            ...
            # Match exponential fit parameters for this leg index
            exp_params = master_BCB_exponential[date][j]  # Use 'j' directly
            D = exp_params['D']
            n0 = exp_params['n0']
            
            # Match gRh_mean for this leg index
            gRh_mean = filtered_master_BCB_gRH[i][j]['gRh_mean'][0]
            dryintercept = n0 * gRh_mean
