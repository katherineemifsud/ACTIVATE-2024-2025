...
ax1.scatter(bin_center,  final_clear_conc[11], label='Leg 12', color='lavender')
ax2.scatter(bin_center, final_cloud_conc[11], label='Leg 12', color='lavender')
...
ax1.scatter(bin_center,  final_clear_conc[14], label='Leg 15', color='grey')
ax2.scatter(bin_center, final_cloud_conc[14], label='Leg 15', color='grey')
