...
for date in dates_CAS:
    ...
    ACB_Start = leg_dictionary['LegIndex_02']['StartTimes']
    ACB_Stop = leg_dictionary['LegIndex_02']['StopTimes']
...
ax1.scatter(bin_center,  final_clear_conc[11], label='Leg 12', color='gold')
ax2.scatter(bin_center, final_cloud_conc[11], label='Leg 12', color='gold')
ax1.scatter(bin_center,  final_clear_conc[12], label='Leg 13', color='royalblue')
ax2.scatter(bin_center, final_cloud_conc[12], label='Leg 13', color='royalblue')
ax1.scatter(bin_center,  final_clear_conc[13], label='Leg 14', color='deeppink')
ax2.scatter(bin_center, final_cloud_conc[13], label='Leg 14', color='deeppink')
ax1.scatter(bin_center,  final_clear_conc[14], label='Leg 15', color='slategrey')
ax2.scatter(bin_center, final_cloud_conc[14], label='Leg 15', color='slategrey')
ax1.scatter(bin_center,  final_clear_conc[15], label='Leg 16', color='khaki')
ax2.scatter(bin_center, final_cloud_conc[15], label='Leg 16', color='khaki')
ax1.scatter(bin_center,  final_clear_conc[16], label='Leg 17', color='orangered')
ax2.scatter(bin_center, final_cloud_conc[16], label='Leg 17', color='orangered')
ax1.scatter(bin_center,  final_clear_conc[17], label='Leg 18', color='coral')
ax2.scatter(bin_center, final_cloud_conc[17], label='Leg 18', color='coral')

ax1.set_xlim([10**0.2, 10**1.8])
ax1.set_ylim([10**-4.7, 10**1])
ax2.set_xlim([10**0.2, 10**1.8])
ax2.set_ylim([10**-2.8, 10**3])

# Set plot properties for the first subplot
ax1.set_yscale('log')
ax1.set_xscale('log')
ax1.set_title(f'{date} BCB Clear Mean Droplet\n Concentration vs Bin Size', fontsize=16, fontweight='bold')
