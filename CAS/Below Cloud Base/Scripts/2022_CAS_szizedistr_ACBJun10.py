...
ax1.scatter(bin_center,  final_clear_conc[8], label='Leg 9', color='olive')
ax2.scatter(bin_center, final_cloud_conc[8], label='Leg 9', color='olive')
