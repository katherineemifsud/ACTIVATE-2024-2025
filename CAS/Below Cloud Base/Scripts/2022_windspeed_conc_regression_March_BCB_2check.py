...
#'2022-03-03',
summary=[]
dates_sum = ['2022-03-02', '2022-03-04', #'2022-03-07' 
              '2022-03-13', '2022-03-14', '2022-03-18', '2022-03-22',
              '2022-03-26','2022-03-28']
#2022-03-26','2022-03-29''2022-03-03',
...
dates_legs= ['2022-03-02',  '2022-03-04', #'2022-03-07', 
             '2022-03-13', '2022-03-14', '2022-03-18', '2022-03-22', '2022-03-26',
              '2022-03-28']
#'2022-03-03','2022-03-29''2022-03-26',
...
dates_twoDS = ['2022-03-02',  '2022-03-04', #'2022-03-07', 
             '2022-03-13', '2022-03-14', '2022-03-18', '2022-03-22', '2022-03-26',
              '2022-03-28']
...
dates_CAS = ['2022-03-02',  '2022-03-04', #'2022-03-07',
              '2022-03-13', '2022-03-14', '2022-03-18', '2022-03-22', '2022-03-26',
              '2022-03-28']
#'2022-03-03','2022-03-29''2022-03-26',
...
plt.title('Below Cloud Base March 2022', fontsize=14, fontweight='bold')
...
# %%
# Check for missing values in wind speed data
missing_values_wind = sum(np.isnan(corrected_windspeeds))
print("Missing values in wind speed data:", missing_values_wind)

# Check for missing values in droplet concentration data
missing_values_droplet = sum(np.isnan(sum_values_Y))
print("Missing values in droplet concentration data:", missing_values_droplet)

# Ensure data alignment by comparing dates
missing_dates = set(dates_Y) - set(wind_mapping.keys())
print("Missing dates in wind speed data:", missing_dates)

# Data Cleaning and Alignment: Handle missing values or misaligned dates
# For example, you can interpolate missing values or drop incomplete entries

# Validate Data Consistency
if len(corrected_windspeeds) == len(sum_values_Y):
    print("Number of observations consistent between wind speed and droplet concentration data.")
else:
    print("Number of observations inconsistent between wind speed and droplet concentration data.")
...
#   'BCB_start': 54207,
#   'BCB_stop': 54435,
#   'Sum': 14.33746206436172},
#Time series for one leg of 3/04 where the total droplet concentration for clear skies is 
# is 14.33 /cm^3 the start time is 54207 and the stop time is 54435.  

#is for a Below Cloud Base leg. I have 

#%%
time_CAS_BCB = []
legs_info = []

# Filter data for '2022-03-04'
filtered_indices = [i for i, date in enumerate(dates_legs) if date == '2022-03-04']

# print("Processing data for date '2022-03-04'")
...
plt.title('2022-03-04\n 54207 - 54435 seconds after midnight\n Clear sky', fontsize=16, fontweight='bold')
plt.show()
# %%
#Time series for one leg of 03/04 where the liquid water content for clear skies is 
# is plotted against the start time 54207 and the stop time 54435.  
# for a Below Cloud Base leg. 
#%%
lwc_CAS_BCB = []
