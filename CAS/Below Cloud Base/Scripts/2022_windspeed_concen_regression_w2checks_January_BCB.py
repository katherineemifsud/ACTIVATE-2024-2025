...
plt.title('Below Cloud Base January 2022', fontsize=14, fontweight='bold')
...
#%%
#Time series for one leg of 1/26 where the liquid water content for clear skies is 
# is plotted against the start time 47722 and the stop time 4796.  
...
filtered_indices = [i for i, date in enumerate(dates_legs) if date == '2022-01-26']
...
for i in filtered_indices:
    ...
    if BCB_start_list and BCB_stop_list:
        ...
        BCB_start = int(BCB_start_list[1])
        BCB_stop = int(BCB_stop_list[1])
        print(f"Leg at date {date} has start time: {BCB_start}, stop time: {BCB_stop}")
...
plt.title('2022-01-26\n 47722 - 47926 seconds after midnight\n Clear sky', fontsize=16, fontweight='bold')
plt.show()
# %%
#Time series for one leg of 1/26 where the liquid water content for clear skies is 
# is plotted against the start time 47722 and the stop time 47026.  
#for a Below Cloud Base leg.I plotted both the 
...
# Filter data for '2022-01-26'
filtered_indices = [i for i, date in enumerate(dates_legs) if date == '2022-01-26']

# print("Processing data for date '2022-01-26'")
...
#Time series for one leg of 1/26 where the total droplet concentration for clear skies is 
# about 2 /cm^3 the start time is 47722 and the stop time is 479262.  

#This time series runs from 47722  to 479262 and is for a Below Cloud Base leg. I have 
...
plt.title('2022-01-26\n 47722 - 479262 seconds after midnight\n Clear sky', fontsize=16, fontweight='bold')
plt.show()
