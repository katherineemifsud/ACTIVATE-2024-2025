...
bin_ranges = [(2.0, 2.5), (2.5, 3), (3, 3.5), (3.5, 4), (4, 5), (5, 6.5), (6.5, 7.2), (7.2, 7.9), 
              (7.9, 10.2), (10.2, 12.5), (12.5, 15), (15, 20), (20, 25), (25, 30), (30, 35), 
              (35, 40), (40, 45), (45, 50)]

bin_log = []

for i in range(len(bin_ranges)):
    lower_bound, upper_bound = bin_ranges[i]
    bin_log.append(math.log(upper_bound) - math.log(lower_bound))
...
# 0.555, 0.645, 0.715, 0.785, 0.855, 0.925, 
#             0.995, 1.07, 1.14, 1.21, 1.38, 1.75,
# D0 = (0.61-0.5)
# D01 = (0.68-0.61)
# D02 = (0.75-0.68)
# D03 = (0.82-0.75)
...
for date in dates_sum:
    ...
    fname_sum = sorted(glob.glob(f'/home/disk/eos4/kathem24/activate/data/MET/2022/SummaryREAL/ict/ACTIVATE-SUMMARY_HU25_{datestr}_R*.csv'), reverse=True)
    # print(date)
    # print(fname_sum)
...
#%%
#Checking corrected wind speed for master_Min flights

Z10=10
Z0=0.03
V1=4.798512820512821
Z1=115.61964102564102
jan12 = V1 * (np.log(Z10/Z0) / np.log(Z1/Z0))
print(jan12)
...
#%%
#Checking corrected wind speed for master_BCB flights

Z10=10
Z0=0.03
V1=4.0374407582938385
Z1=737.6134123222749
jan13 = V1 * (np.log(Z10/Z0) / np.log(Z1/Z0))
print(jan13)
#%%
Z0 = 0.03  # meters (typical value for open terrain)
Z10 = 10  # target height m
...
X = df['Mean Wind Speed (m/s)']  # Independent variable
y = df['Droplet Concentration']  # Dependent variable
...
plt.title('Minimum altitude January 2022 - June 2022', fontsize=14, fontweight='bold')
plt.xlabel('Total droplet concentration dN (per cm^3) for clear skies ', fontsize=14, fontweight='bold')
plt.ylabel('Mean windspeed (m/s)', fontsize=14, fontweight='bold')
plt.xscale('log')
plt.show()
...
# Create the scatterplot
plt.scatter(sum_values2, corrected_windspeeds2)
plt.title('Minimum altitude January 2022 - June 2022', fontsize=14, fontweight='bold')
plt.xlabel('Total droplet concentration dN (per cm^3) for cloudy skies ', fontsize=14, fontweight='bold')
plt.ylabel('Mean windspeed (m/s)', fontsize=14, fontweight='bold')
plt.xscale('log')
