...
ax1.scatter(bin_center,  final_clear_conc[7], label='Leg 8', color='grey')
ax2.scatter(bin_center, final_cloud_conc[7], label='Leg 8', color='grey')
...
ax1.scatter(bin_center,  final_clear_conc[10], label='Leg 11', color='gold')
ax2.scatter(bin_center, final_cloud_conc[10], label='Leg 11', color='gold')
ax1.scatter(bin_center,  final_clear_conc[11], label='Leg 12', color='cyan')
ax2.scatter(bin_center, final_cloud_conc[11], label='Leg 12', color='cyan')
ax1.scatter(bin_center,  final_clear_conc[12], label='Leg 13', color='blueviolet')
ax2.scatter(bin_center, final_cloud_conc[12], label='Leg 13', color='blueviolet')
