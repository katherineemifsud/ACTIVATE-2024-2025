...
ax1.scatter(bin_center,  final_clear_conc[7], label='Leg 8', color='cyan')
ax2.scatter(bin_center, final_cloud_conc[7], label='Leg 8', color='cyan')
ax1.scatter(bin_center,  final_clear_conc[8], label='Leg 9', color='darkgreen')
ax2.scatter(bin_center, final_cloud_conc[8], label='Leg 9', color='darkgreen')
