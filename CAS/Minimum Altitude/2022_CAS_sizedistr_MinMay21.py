...
ax1.scatter(bin_center,  final_clear_conc[15], label='Leg 16', color='olive')
ax2.scatter(bin_center, final_cloud_conc[15], label='Leg 16', color='olive')
...
ax1.scatter(bin_center,  final_clear_conc[18], label='Leg 19', color='grey')
ax2.scatter(bin_center, final_cloud_conc[18], label='Leg 19', color='grey')
