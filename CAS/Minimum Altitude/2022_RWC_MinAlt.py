...
for entry in Y_Min_calc:
    date = entry['Date']
    start_time = entry['Min_start']
    stop_time = entry['Min_stop']
...
plt.title("Comparison of High & Low GCCN Flight Concentrations\n Minimum Altitude", fontsize=16, fontweight="bold")
plt.grid(axis="y", linestyle="--", alpha=0.7)
...
plt.title("Comparison of High & Low GCCN Flight Mass\n Minimum Altitude", fontsize=19, fontweight="bold")
plt.grid(axis="y", linestyle="--", alpha=0.7)
plt.tick_params(axis="both", which="major", labelsize=19, width=3, length=8)
plt.tick_params(axis="both", which="minor", labelsize=19, width=2, length=5)
plt.show()
...
plt.xticks(fontsize=19, fontweight='bold')
plt.yticks(fontsize=19, fontweight='bold')
plt.title('High GCCN Mass Flights January-June 2022\n Minimum Altitude', fontsize=19, fontweight='bold')
plt.tight_layout()
plt.show()
...
plt.xticks(fontsize=19, fontweight='bold')
plt.yticks(fontsize=19, fontweight='bold')
plt.title('Low GCCN Mass Flights January-June 2022\n Minimum Altitude', fontsize=19, fontweight='bold')
plt.tight_layout()
plt.show()
...
plt.xticks(fontsize=19, fontweight='bold')
plt.yticks(fontsize=19, fontweight='bold')
plt.title('High GCCN Flights January-June 2022\n Minimum Altitude', fontsize=19, fontweight='bold')
plt.tight_layout()
plt.show()
plt.figure(figsize=(8, 6))
plt.pcolormesh(xedges, yedges, masked_rwc_low.T, cmap="RdBu_r", norm=norm, shading='auto')
...
plt.xticks(fontsize=19, fontweight='bold')
plt.yticks(fontsize=19, fontweight='bold')
plt.title('Low GCCN Flights January-June 2022\n Minimum Altitude', fontsize=19, fontweight='bold')
plt.tight_layout()
plt.show()
#%%
...
plt.xlabel(r'Nr+Nc (cm$^{-3}$)', fontsize=19, fontweight='bold')
plt.ylabel(r'LWC (g m$^{-3}$)', fontsize=19, fontweight='bold')
plt.title('High GCCN Mass Flights\n Minimum Altitude', fontsize=19, fontweight='bold')
plt.tick_params(axis='both', which='major', labelsize=19, width=3, length=8)
plt.tick_params(axis='both', which='minor', labelsize=19, width=2, length=5)
plt.tight_layout()
plt.show()
...
plt.xlabel(r'Nr+Nc (cm$^{-3}$)', fontsize=19, fontweight='bold')
plt.ylabel(r'LWC (g m$^{-3}$)', fontsize=19, fontweight='bold')
plt.title('Low GCCN Mass Flights\n Minimum Altitude', fontsize=19, fontweight='bold')
plt.tick_params(axis='both', which='major', labelsize=19, width=3, length=8)
plt.tick_params(axis='both', which='minor', labelsize=19, width=2, length=5)
plt.tight_layout()
plt.show()
...
plt.xlabel("GCCN Flight Category", fontsize=19, fontweight="bold")
plt.title("RWC High & Low GCCN Mass Flights\n Minimum Altitude", fontsize=17, fontweight="bold")
plt.grid(axis="y", linestyle="--", alpha=0.7)
plt.tick_params(axis="both", which="major", labelsize=19, width=3, length=8)
plt.tick_params(axis="both", which="minor", labelsize=19, width=2, length=5)
...
plt.ylabel("RWC (g/m³)", fontsize=19, fontweight="bold")
plt.xlabel("GCCN Flight Category", fontsize=19, fontweight="bold")
plt.title("RWC for Mass & Concentration\n Minimum Altitude", fontsize=17, fontweight="bold")
plt.grid(axis="y", linestyle="--", alpha=0.7)
plt.tick_params(axis="both", which="major", labelsize=14, width=3, length=8)
plt.tick_params(axis="both", which="minor", labelsize=19, width=2, length=5)
...
# Labels and title
plt.title('Difference in RWC/LWC \nbetween High and Low GCCN Mass Flights\n Minimum Altitude', fontsize=17, fontweight='bold')
plt.xlabel(r'Nr+Nc (cm$^{-3}$)', fontsize=19, fontweight='bold')
plt.ylabel(r'LWC (g m$^{-3}$)', fontsize=19, fontweight='bold')
