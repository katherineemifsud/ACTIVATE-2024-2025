...
wind_speed_dict = {
    (row['Date'], row['Min_start'], row['Min_stop']): row['Windspeed']
...
for entry in total_concentration_cm3_Min:
    key = (entry['Date'], entry['Min_start'], entry['Min_stop'])

    if key in wind_speed_dict:
        matched_total_concentrations.append(entry['Total_Y_Concentration_cm3_Min'])
