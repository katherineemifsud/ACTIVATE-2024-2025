...
fcdp_slope_file = f"{base_path}/FCDP_slope_massLE1002020.pkl"
fcdp_ddry_file  = f"{base_path}/FCDP_ddry_massLE1002020.pkl"
...
datasets = [
    ("CAS 2020", cas_conc, cas_mass, cas_D, "s"),
    ("CDP 2020", cdp_conc, cdp_mass, cdp_D, "^"),
    ("FCDP 2020", fcdp_conc, fcdp_mass, fcdp_D, "D")
]
