...
# %%
load_path = "/home/disk/eos4/kathem24/activate/data/2021/CDP/1Hz/CDP_2021_wind_bin_concentration_plot_data.pkl"
...
plt.show()
#%%
load_path = "/home/disk/eos4/kathem24/activate/data/2021/CDP/1Hz/CDP_2021_wind_bin_mass_plot_data.pkl"
...
plt.xlabel("Wind Speed (m s$^{-1}$)", fontsize=20, fontweight='bold')
plt.ylabel("Total Dry Mass (µg/m³)", fontsize=20, fontweight='bold')
plt.title("CAS Below Cloud Base\nNovemeber-December 2021", fontsize=20, fontweight='bold')
plt.legend(fontsize=11, frameon=False, loc='upper left')
plt.xlim(0, 12)
plt.ylim(0, 31)
plt.xticks(fontsize=18, fontweight='bold')
...
# %%
#mass 
cas_path = "/home/disk/eos4/kathem24/activate/data/2021/CAS/CAS_ND2021_wind_bin_mass_plot_data.pkl"
with open(cas_path, "rb") as f:
    cas = pickle.load(f)
cdp_path = "/home/disk/eos4/kathem24/activate/data/2021/CDP/1Hz/CDP_2021_wind_bin_mass_plot_data.pkl"
...
cas_path = "/home/disk/eos4/kathem24/activate/data/2021/CAS/CAS_ND2021_wind_bin_concentration_plot_data.pkl"
with open(cas_path, "rb") as f:
    cas = pickle.load(f)
cdp_path = "/home/disk/eos4/kathem24/activate/data/2021/CDP/1Hz/CDP_2021_wind_bin_concentration_plot_data.pkl"
with open(cdp_path, "rb") as f:
    cdp = pickle.load(f)
...
fcdp_path = "/home/disk/eos4/kathem24/activate/data/2021/FCDP/FCDP_JanuaryJune2021_wind_bin_concentration_plot_data.pkl"
...
fcdp_path = "/home/disk/eos4/kathem24/activate/data/2021/FCDP/FCDP_JanuaryJune2021_wind_bin_mass_plot_data.pkl"
with open(fcdp_path, "rb") as f:
    fcdp = pickle.load(f)
plt.figure(figsize=(12, 6))
box_width = 0.6
