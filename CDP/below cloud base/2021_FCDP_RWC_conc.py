...
for i in range(len(dates_legs)):
    ...
    FCDP_bins = {f"dNdlogD_{bin_label:03d}_FCDP":FCDP_flight[f"dNdlogD_{bin_label:03d}_FCDP"].values for bin_label in range(3, 21)
}
        ...
        for FCDP_idx in FCDP_indices_in_range:
            ...
            if lwc_val >= 0.00001:
                ...
                for bin_label in range(3, 21):
                    ...
                    calc_entry[bin_key] = FCDP_bins[f'dNdlogD_{bin_label:03d}_FCDP'][FCDP_idx]
...
for i in range(len(dates_legs)):
    ...
    bin_widths = [bin_log_FCDP[bin_label] for bin_label in range(3, 21)]
        ...
        for FCDP_idx in FCDP_indices_in_range:
            ...
            if lwc_val >= 0.00001:
                total_concentration = sum(
                    np.nan_to_num(FCDP_bins[f'dNdlogD_{bin_label:03d}_FCDP'][FCDP_idx]) * bin_width
                    for bin_label, bin_width in zip(range(3, 21), bin_widths)
                )
                calc_entry = {
                    'Date': date,
                    'Time': FCDP_times[FCDP_idx],
...
plt.title('FCDP in-cloud January - June 2021', fontsize=18, fontweight='bold')
plt.grid(which="both", linestyle='--', linewidth=0.5, alpha=0.7)
plt.show()
...
plt.tight_layout()
# fig.savefig("RWC_FCDP.pdf", dpi=300, bbox_inches='tight')
# plt.show()
# fig.savefig("RWC_RWC_FCDP.pdf", dpi=300, bbox_inches='tight')
#%%
#fixing for paper 
...
plt.xlabel('Nr+Nc /cm³', fontsize=19, fontweight='bold')
plt.ylabel('LWC g/m³', fontsize=19, fontweight='bold')
plt.title('Mean LWC\nJanuary–June 2021 (CDP in cloud)', fontsize=18, fontweight='bold')
plt.tight_layout()
plt.show()
#%%
#%%
...
plt.title('CDP in-cloud January-June 2021', fontsize=18, fontweight='bold')
plt.tick_params(axis='both', which='major', labelsize=12, width=3, length=8)
plt.tick_params(axis='both', which='minor', labelsize=12, width=2, length=5)
...
#%%
with open("FCDP_concentration_massLE1002021.pkl", "rb") as f:
    filtered_concentration_FCDP = pickle.load(f)
print("Number of filtered concentration legs:",
    len(filtered_concentration_FCDP))
print("First entry:")
print(filtered_concentration_FCDP[0])
#%%
from collections import defaultdict
GCCN_flight_totals = defaultdict(lambda: {'Legs': [], 'Total_GCCN_Concentration': 0, 'Leg_Count': 0})
for entry in filtered_concentration_FCDP:
    date = entry['Date']
    start_time = entry['BCB_start']
    stop_time = entry['BCB_stop']
    total_gccn_leg = entry['Total_Y_Concentration_cm3']
...
plt.xticks(fontsize=19, fontweight='bold')
plt.yticks(fontsize=19, fontweight='bold')
plt.title('High GCCN Flights FCDP January-June 2021', fontsize=19, fontweight='bold')
plt.tight_layout()
plt.show()
plt.figure(figsize=(8, 6))
...
plt.xticks(fontsize=19, fontweight='bold')
plt.yticks(fontsize=19, fontweight='bold')
plt.title('Low GCCN Flights FCDP January-June 2021', fontsize=19, fontweight='bold')
plt.tight_layout()
plt.show()
...
plt.xlabel('Nr+Nc /cm³', fontsize=16, fontweight='bold')
plt.ylabel('LWC g/m³', fontsize=16, fontweight='bold')
plt.title('High GCCN FCDP Flights January-June 2021', fontsize=18, fontweight='bold')
plt.tight_layout()
plt.show()
plt.figure(figsize=(8, 6))
...
plt.xlabel('Nr+Nc /cm³', fontsize=16, fontweight='bold')
plt.ylabel('LWC g/m³', fontsize=16, fontweight='bold')
plt.title('Low GCCN FCDP Flights January-June 2021', fontsize=18, fontweight='bold')
plt.tight_layout()
plt.show()
#%%
...
plt.xticks(fontsize=19, fontweight='bold')
plt.yticks(fontsize=19, fontweight='bold')
plt.title('Mean RWC — High GCCN FCDP Flights \nJanuary–June 2021)', fontsize=19, fontweight='bold')
plt.tight_layout()
plt.show()
plt.figure(figsize=(8, 6))
...
plt.xticks(fontsize=19, fontweight='bold')
plt.yticks(fontsize=19, fontweight='bold')
plt.title('Mean RWC — Low GCCN FCDP Flights January–June 2021', fontsize=19, fontweight='bold')
plt.tight_layout()
plt.show()
#%%
#fixing gray NANs
...
plt.xticks(fontsize=19, fontweight='bold')
plt.yticks(fontsize=19, fontweight='bold')
plt.title('Mean LWC — High GCCN FCDP Flights January–June 2021', fontsize=19, fontweight='bold')
plt.tight_layout()
plt.show()
...
plt.xticks(fontsize=19, fontweight='bold')
plt.yticks(fontsize=19, fontweight='bold')
plt.title('Mean LWC — Low GCCN FCDP Flights January–June 2021', fontsize=19, fontweight='bold')
plt.tight_layout()
plt.show()
#%%
...
plt.xlabel(r"Nr+Nc (cm$^{-3}$)", fontsize=19, fontweight="bold")
plt.ylabel(r"LWC (g m$^{-3}$)", fontsize=19, fontweight="bold")
plt.title("FCDP RWC Ratio — High / Low GCCN Flights", fontsize=19, fontweight="bold")
plt.tight_layout()
plt.show()
plt.figure(figsize=(8,6))
img = plt.pcolormesh(
...
plt.xlabel(r"Nr+Nc (cm$^{-3}$)", fontsize=19, fontweight="bold")
plt.ylabel(r"LWC (g m$^{-3}$)", fontsize=19, fontweight="bold")
plt.title("FCDP Ratio — High / Low GCCN Flights", fontsize=19, fontweight="bold")
plt.tight_layout()
plt.show()
#%%
masked_avg_rwc_low = np.ma.masked_where(np.isnan(avg_rwc_low), avg_rwc_low)
...
plt.xlabel(r'Nr+Nc (cm$^{-3}$)', fontsize=19, fontweight='bold')
plt.ylabel(r'LWC (g m$^{-3}$)', fontsize=19, fontweight='bold')
plt.title('FCDP Low GCCN Flights — Mean RWC', fontsize=19, fontweight='bold')
plt.tick_params(axis='both', which='major', labelsize=19, width=3, length=8)
plt.tick_params(axis='both', which='minor', labelsize=19, width=2, length=5)
plt.tight_layout()
plt.show()
...
plt.xlabel(r'Nr+Nc (cm$^{-3}$)', fontsize=19, fontweight='bold')
plt.ylabel(r'LWC (g m$^{-3}$)', fontsize=19, fontweight='bold')
plt.title('FCDP Low GCCN Flights — Mean LWC', fontsize=19, fontweight='bold')
plt.tick_params(axis='both', which='major', labelsize=19, width=3, length=8)
plt.tick_params(axis='both', which='minor', labelsize=19, width=2, length=5)
plt.tight_layout()
plt.show()
...
plt.xlabel(r"Nr+Nc (cm$^{-3}$)", fontsize=19, fontweight="bold")
plt.ylabel(r"LWC (g m$^{-3}$)", fontsize=19, fontweight="bold")
plt.title("FCDP RWC Ratio — High / Low GCCN Mass Flights", fontsize=19, fontweight="bold")
plt.tight_layout()
plt.show()
plt.figure(figsize=(8,6))
img = plt.pcolormesh(
...
cbar = plt.colorbar(img)
cbar.set_label("FCDP LWC Ratio (High / Low)", fontsize=18, fontweight="bold")
cbar.ax.tick_params(labelsize=16)
for t in cbar.ax.get_yticklabels():
    t.set_fontweight("bold")
plt.xscale("log")
...
plt.xlabel(r"Nr+Nc (cm$^{-3}$)", fontsize=19, fontweight="bold")
plt.ylabel(r"LWC (g m$^{-3}$)", fontsize=19, fontweight="bold")
plt.title("FCDP LWC Ratio — High / Low GCCN Flights", fontsize=19, fontweight="bold")
plt.tight_layout()
plt.show()
#%%
...
#saving
# import copy
# save_dir = "/home/disk/eos4/kathem24/activate/data/2021/CDP"
# os.makedirs(save_dir, exist_ok=True)

# save_path = os.path.join(
#     save_dir,
#     "2021CDP_RWC_high_low_heatmap_data_conc.pkl"
# )
# cdp_rwc_heatmap_data = {
...
#     pickle.dump(cdp_rwc_heatmap_data, f, protocol=pickle.HIGHEST_PROTOCOL)

# print(f"Saved CDP heatmap data to:\n{save_path}")
# %%
