...
df_fcdp = df_fcdp[df_fcdp["Date"].astype(str).str.startswith("2021-")].copy()
...
plt.title("Dry Mass Timeline (January-June 2021)\nLegs ordered by Date then BCB_start",
...
df_fcdp = pd.DataFrame(filtered_slope_mass100gone).copy()
df_fcdp = df_fcdp[
    df_fcdp["Date"].astype(str).str.startswith("2021-")
].copy()
df_fcdp["Month"] = (
    df_fcdp["Date"]
    .astype(str)
...
plt.ylabel("GCCN Mass (µg/m³)", fontsize=16, fontweight="bold")
plt.xlabel("Leg index", fontsize=16, fontweight="bold")
plt.title("FCDP BCB Mass January-June 2021\nMonthly Means", fontsize=18, fontweight="bold")
plt.legend(ncol=2, fontsize=10)
plt.yticks(fontsize=14, fontweight="bold")
plt.xticks(fontsize=14, fontweight="bold")
plt.tight_layout()
...
plt.title("FCDP BCB Slope January-June 2021",
          fontsize=18, fontweight="bold")
plt.tight_layout()
plt.show()
# %%
...
plt.ylabel("Slope (D)", fontsize=16, fontweight="bold")
plt.xlabel("Leg index", fontsize=16, fontweight="bold")
plt.title("FCDP BCB Slope (D) January-June 2021",
          fontsize=18, fontweight="bold")
plt.legend(ncol=2, fontsize=10)
plt.yticks(fontsize=14, fontweight="bold")
plt.xticks(fontsize=14, fontweight="bold")
...
plt.xlabel("Leg index", fontsize=16, fontweight="bold")
plt.title("FCDP BCB Dry Slope (D) January-June 2021\nMonthly Means", fontsize=18, fontweight="bold")
plt.legend(ncol=2, fontsize=10)
plt.yticks(fontsize=14, fontweight="bold")
plt.xticks(fontsize=14, fontweight="bold")
plt.tight_layout()
...
ax.set_title("FCDP BCB Slope (D) January-June 2021\nMonthly Trend", fontsize=18, fontweight="bold")
ax.legend(ncol=2, fontsize=10, loc="upper right")
ax.set_xticks(tick_pos)
...
dfp_fcdp = dfp_fcdp[dfp_fcdp["Date"].astype(str).str.startswith("2021-")].copy()
...
with open("FCDP_3panel_seasonaltrend_FMAS2021.pkl", "wb") as f:
...
with open("CDP_3panel_seasonaltrend_2021.pkl", "rb") as f:
    cdp = pickle.load(f)
with open("FCDP_3panel_seasonaltrend_FMAS2021.pkl", "rb") as f:
    fcdp = pickle.load(f)
month_name = {
    1: "January",
    2: "February",
