...
# save_path = os.path.join(save_dir, "BCB_LWC_means_beforemass_FCDP.csv")
# master_BCB_LWC_df = pd.DataFrame(master_BCB_LWC_FCDP)
...
# output_path = "Dry_mass_BCB2022_lessthan100massREAL_FCDP.csv"
...
# with open("FCDP_slope_massLE1002022.pkl", "wb") as f:
#     pickle.dump(filtered_slope_mass100gone, f)
# print("Saved FCDP slope-filtered dataset.")
# print("Saved to:", os.path.abspath("FCDP_slope_massLE1002022.pkl"))
# print("Exists?", os.path.exists("FCDP_slope_massLE1002022.pkl"))
#%%
...
# with open("FCDP_concentration_massLE1002022.pkl", "wb") as f:
...
# with open("FCDP_ddry_massLE1002022.pkl", "wb") as f:
...
# np.savez("FCDP_average_drysize_nomass1002022.npz",
#          bins=common_bins,
#          average=average_dN_dD_dry)
# print("Saved FCDP averaged distribution.")
# print("Saved to:", os.path.abspath("FCDP_ddry_massLE1002022.pkl"))
# print("Exists?", os.path.exists("FCDP_ddry_massLE1002022.pkl"))
#%%
...
filename = "FCDP_surface_area_per_leg_2022.pkl"
...
#%%
# save_dir = "/home/disk/eos4/kathem24/activate/data/2022"
# os.makedirs(save_dir, exist_ok=True)

# save_path = os.path.join(
#     save_dir,
#     "BCB_corrected_windspeed_2022.pkl"
# )

# with open(save_path, "wb") as f:
#     pickle.dump(df_combined, f)

# print(f"Saved corrected wind-speed data to: {save_path}")
#%%
...
save_dir = "/home/disk/eos4/kathem24/activate/data/2022/FCDP"
os.makedirs(save_dir, exist_ok=True)
save_path = os.path.join(save_dir, "FCDP_JanuaryJune2022_wind_bin_concentration_plot_data.pkl")
plot_data = {
...
plt.title("FCDP Below Cloud Base January-June 2022", fontsize=16, fontweight='bold')
legend_labels_mass = [
    plt.Line2D([0], [0], marker='o', color='w', markerfacecolor=colors[idx], markersize=10, 
...
save_dir = "/home/disk/eos4/kathem24/activate/data/2022/FCDP"
os.makedirs(save_dir, exist_ok=True)
save_path = os.path.join(save_dir, "FCDP_JanuaryJune2022_wind_bin_mass_plot_data.pkl")
mass_plot_data = {
    "windspeed_bins": windspeed_bins,
